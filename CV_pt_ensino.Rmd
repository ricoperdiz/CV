...
file <- "C:/Users/ricop/Documents/CV/pubs.bib"
reviews <- "C:/Users/ricop/Documents/PROFISSIONAL/producao_cientifica/08_pareceres/reviews.bib"
out <-
  bib_entries(file) %>%
  prep_bib(.)
...
# Dados profissionais
  ...
  * [Orcid](https://orcid.org/0000-0002-2333-6549) ![Orcid](C:/Users/ricop/Documents/CV/orcid_16x16.png){height=0.5%,width=0.05%}: [0000-0002-2333-6549](https://orcid.org/0000-0002-2333-6549)
...
## Artigos científicos publicados recentemente
...
```{r preprint, results="asis", eval=FALSE}
## Pré-publicação
art_preprint <- 
  filter(out, bibtype == "Article") %>%
...
```{r online-checklist, results="asis", eval=FALSE}
...
```{r datasets, results = "asis", eval=FALSE}
## Conjunto de dados
dsets <- 
